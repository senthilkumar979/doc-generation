...
export function useFormField() {
  ...
  if (!name) throw new Error("useFormField must be used within <FormField>");
...
export const FormMessage = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, children, ...props }, ref) => {
    ...
    if (!body) return null;
    return (
      <p ref={ref} id={formMessageId} data-slot="form-message" className={cn("text-destructive text-xs font-medium", className)} {...props}>
        {body}
      </p>
    );
  },
